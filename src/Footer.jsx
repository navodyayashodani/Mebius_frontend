...
export default function Footer() {
  return (
    <footer className="bg-[#eff5f5] border-t ">
      <div className="container mx-12 px-4 py-8 ">
        <div className="flex flex-wrap justify-between ">
          <div className="w-full md:w-1/4 mb-4 md:mb-0">
            <h2 className="text-xl font-bold mb-2">Mebius</h2>
            <p className="text-sm text-gray-600">Innovative solutions for your business</p>
          </div>
          <div className="w-full md:w-1/4 mb-4 md:mb-0">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/shop">
                  <a className="text-blue-600 hover:underline">Shop</a>
                </Link>
              </li>
              <li>
                <Link to="/contact">
                  <a className="text-blue-600 hover:underline">Contact</a>
                </Link>
              </li>
            </ul>
          </div>
